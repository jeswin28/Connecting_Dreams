...
import 'package:connecting_firebase/pages/auth/register_page.dart';
...
import 'package:connecting_firebase/widgets/widgets.dart';
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const Text("Gateway to study Abroad",
                            style: TextStyle(
                                fontSize: 15, fontWeight: FontWeight.w400)),
                        Image.asset("assets/Universities/login.png"),
                        TextFormField(
    ...
    if (formKey.currentState!.validate()) {
      ...
      await authService
        ...
        if (value == true) {
          ...
          showSnackbar(context, const Color.fromRGBO(102, 244, 194, 1), value);
          setState(() {
            _isLoading = false;
          });
        }
